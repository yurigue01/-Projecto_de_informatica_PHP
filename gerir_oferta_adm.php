  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
    ...
    <div class="page-wrapper">
        <div class="content">
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            $oferta="SELECT oferta.*, empresa.*, tipo_da_oferta.*, area.*, local.*  FROM oferta INNER JOIN empresa ON oferta.Empresa_ID_empresa=empresa.ID_empresa INNER JOIN tipo_da_oferta ON oferta.Tipo_da_Oferta_ID_tipo=tipo_da_oferta.ID_tipo INNER JOIN area ON oferta.Area_idArea=area.idArea INNER JOIN local ON oferta.Local_ID_local=local.ID_local";
            ...
            <td><a href="editar_oferta_emp.php?id='.$row['ID_oferta'].'" class="fa fa-wrench green_color"> Editar</a></td>
            </tr>';
                                }
