...
$Telefone = number_format( $bus['Telefone']);
$Email  = $bus['Email'];
$Morada  = $bus['Morada'];
...
<div class="main-wrapper">
        ...
        <ul class="nav user-menu float-right">
            <li class="nav-item dropdown has-arrow">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="Utilizador/Adm/PerfilAd.html">Meu Perfil</a>
                    <a class="dropdown-item" href="Utilizador/Adm/Editarperfil_ad.html">Editar Perfil</a>
                    <a class="dropdown-item" href="Utilizador/Adm/change_password_ad.html">Alterar Password</a>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="Utilizador/Adm/PerfilAd.html"><i class="fa fa-user"></i> <span>Perfil</span></a>
                    </li>
                    <li>
                        <a href="Utilizador/Adm/GerirGest.html"> <span>
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                    ...
                    <li>
                        <a href="Utilizador/Adm/GerirCandi.html"> <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
  <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"/>
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
</svg>
                            Gerir Candidatos</span></a>
                    </li>
                    <li>
