    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                ...
                <a href="perfil_candidato.php"> <button>Cancelar</button></a>

                        <button type="submit"  >Guardar Alterções</button>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select name="HB" id="">
                                                                    <optgroup label="Ciencias e tecnologias">
                                                                        <option value="volvo">engenharia innformatica</option>
                                                                        <option value="saab">engenharia de informatica e gestao</option>
                                                                    </optgroup>
                                                                    <optgroup label="ciencias socioeconomicas">
                                                                        <option value="mercedes">Economia</option>
                                                                        <option value="audi">Gestao</option>
                                                                    </optgroup>
                                                                    <optgroup label="liguas e humanidades">
                                                                        <option value="mercedes">Direito</option>
                                                                        <option value="audi">Advogacia</option>
                                                                    </optgroup>
                                                                    <optgroup label="Artes">
                                                                        <option value="mercedes">Arquitetura</option>
